...
public class MaintainerPreferenceController extends BasePreferenceController {
    ...
    private static final Uri INTENT_URI_DATA = Uri.parse("https://www.paypal.me/Raghu107");
    private static final String TAG = "MaintainerCtrl";
    private static final String ROM_PROPERTY = "ro.maintainer";
